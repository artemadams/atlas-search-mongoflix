...
const CodeModal = ({ isOpen, setIsOpen, codeExamples }) => {
    function closeModal() {
        setIsOpen(false);
    }
    function openModal() {
                                ...
                                {codeExamples.length !== 0 && (
                                    <>
                                        {codeExamples.map((codeExample) => (
                                            <Disclosure key={codeExample._id}>
                                                {({ open }) => (
                                                    <>
                                                        <Disclosure.Button className="flex justify-between w-full px-4 py-2 my-2 text-sm font-medium text-left text-green-900 bg-green-100 rounded-lg hover:bg-green-200 focus:outline-none focus-visible:ring focus-visible:ring-green-500 focus-visible:ring-opacity-75">
